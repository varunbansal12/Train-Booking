...
<hr>
      ...
      <div id="horizontal-two-items" class="IMGS IMGS_AVs">
        ...
        <div>
          ...
          <p> Vishu Express is a Superfast Express train belonging to Indian Railways – Northern Railway zone that runs between New Delhi and Amritsar Junction in India.

It operates as train number 12497 from New Delhi to Amritsar Junction and as train number 12498 in the reverse direction serving the states of Delhi, Haryana and Punjab.</p>
          <br>
          <p>Current Rate: <b>600.00</b></p>
        </div>
      </div>
      <hr>
      <form action="saving_appointment.php?vehicle=Vishu Express" method="POST" style="width:350px; padding:5px;margin:15px;margin-top:20px;">
        <fieldset>
          <legend>Book your train:</legend>
          <label for="startDate">Start Date: </label>
          <input type="hidden" value="BMW">
          <input type="date"  name="startDate" value="2022-11-30" required><br><br>
          ...
          <input type="submit">
           ...
           <?php
$query = "Select * from reviews where vehicle = 'bmw'";
...
echo '</ol>' . '</div>';
echo '<form  action="insertreview.php?vehicle=bmw" method="POST">';
