...
?>
    ...
    <center>
      <h2>
        <span id="maps"> All User Rentals</span>
      </h2>
       <br /><br />    
                    
    <table border = "5"  bgcolor="grey" style="color:white; font-size:24px;">
    <?php
    $total = 0;
    ...
    echo "<tr bgcolor=\"#007488\">"
            . "<td style=\"text-align: center;\"><b>&nbsp User &nbsp</b></td>"
    ...
    . "</tr>";    
        ...
        for ($j = 0; $j < $r; $j++) {
            ...
            $a = $fetched_row['ID'];
            $b = $fetched_row['vehicle_code'];
            $c = $fetched_row['no_passenger'];
            $d = $fetched_row['startDate'];
            $e = $fetched_row['total_price'];
            $total += $e;
            echo "<tr>"
                    . "<td style=\"text-align: right;\">&nbsp $a &nbsp</td>"
                    . "<td style=\"text-align: right;\">&nbsp $b &nbsp</td>"
        ...
        echo "</table> <br /><br />
          <h3>*** Total Earnings: <b>$$total.00 ***</b></h3>
          <br /><br />";
    }       
    ?>
   </center>
