...
<hr>
      ...
      <h3>Muskaan Express</h3>
      <div id="horizontal-two-items" class="IMGS IMGS_AVs">
        
        <div>
          <h3 style="margin-left:40px"></h3>
          <p>The Muskaan Express is a series of passenger train service in India operated by Indian Railways connecting the national capital New Delhi with the capitals ...
Operating speed: Maximum 130–140 km/</p>
          <br>
          <p>Current Rate: <b>400.00 </b></p>
        </div>
      </div>
      <hr>
      <form action="saving_appointment.php?vehicle=Mus Express" method="POST" style="width:350px; padding:5px;margin:15px;margin-top:20px;">
        <fieldset>
          <legend>Book your train:</legend>
          <label for="startDate">Start Date: </label>
          <input type="hidden" value="fordf150">
          ...
          <input type="submit">
                ...
                <?php
$query = "Select * from reviews where vehicle = 'f_150'";
...
echo'</ol>'.'</div>';
  echo'<form  action="insertreview.php?vehicle=f_150" method="POST">';
